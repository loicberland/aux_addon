...
function status(enabled)
	return (enabled and color.green'activé' or color.red'désactivé')
end
...
function SlashCmdList.AUX(command)
    ...
    elseif arguments[1] == 'tooltip' and arguments[2] == 'merchant' and arguments[3] == 'buy' then
        ...
        print("Prix d'achat marchand dans l'infobulle " .. status(tooltip_settings.merchant_buy))
    elseif arguments[1] == 'tooltip' and arguments[2] == 'merchant' and arguments[3] == 'sell' then
        ...
        print("Prix de vente marchand dans l'infobulle " .. status(tooltip_settings.merchant_sell))
    elseif arguments[1] == 'tooltip' and arguments[2] == 'disenchant' and arguments[3] == 'value' then
        ...
        print("Valeur de désenchantement dans l'infobulle " .. status(tooltip_settings.disenchant_value))
    elseif arguments[1] == 'tooltip' and arguments[2] == 'disenchant' and arguments[3] == 'distribution' then
        ...
        print("Résultats de désenchantement dans l'infobulle " .. status(tooltip_settings.disenchant_distribution))
    elseif arguments[1] == 'clear' and arguments[2] == 'item' and arguments[3] == 'cache' then
	    _G.aux_items = {}
	    _G.aux_item_ids = {}
	    _G.aux_auctionable_items = {}
        print("Cache d'objets vidé.")
